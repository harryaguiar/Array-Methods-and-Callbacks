...
// const finalsData = finals.map(function getFinals(data) {
//     if (data["Stage"] === "Final") {
//         return true
//     }
...
// console.log(finalsData(fifaData));

/* Task 3: Implement a higher-order function called `getYears` that accepts the callback function `getFinals`, and returns an array called `years` containing all of the years in the dataset */

const finalsYears = finalsData.map(getFinals);

function getYears(getFinalsCB) {
    return getFinals
};

getYears(finalsYears);
console.log(getYears(getFinals['Years']));
